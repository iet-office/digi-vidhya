  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="stat-boxes">
        ...
        <div style="padding: 0px 20px;width:75%;">
          <table>
            <thead>
              <tr>
                <th>Exam no.</th>
        ...
        <div class="top-stat box" style="margin: 0px 20px 20px 0px;">
          ...
          <form action="addexam.php" method="post">
            ...
            <label for="nq">duration (Minutes)</label><br>
            <input class="inputbox" type="number" id="duration" name="duration" required /></br>
