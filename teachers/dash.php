    ...
    <div class="home-content">
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            ...
            <div class="number"><?php $sql = "SELECT COUNT(1) FROM student";
      ...
      <div class="stat-boxes">
        <div class="recent-stat box">
          <div class="title">Recent skill assesment results</div>
          <table id="res" style="table-layout:auto; width:75%;">
            <thead>
              <tr>
                <th id="res">Date</th>
                <th id="res">Name</th>
                <th id="res">Exam name</th>
                <th id="res">Percentage</th>
                <th id="res">Certificate Id</th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              ?>
                  <tr>
                    ...
                    <td id="res"><?php echo $row['certificate_id']; ?></td>
                  </tr>
              <?php
                }
              }
